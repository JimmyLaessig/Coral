...
inline std::optional<Coral::ShaderLanguage::ShaderGraph::CompilerResult> TexturedWithLightingShader()
{
	...
	Coral::ShaderLanguage::ShaderGraph::CompilerSPV compiler;
	compiler.setShaderProgram(progam);
