...
public:
	...
	virtual bool cmdClearImage(Coral::Image* image, const CoClearColor& clearColor) = 0;
	 ...
	 * \param offset The offset from the base address of the buffer to the first element in bytes
	 */
	virtual bool cmdBindIndexBuffer(Coral::Buffer* buffer, CoIndexFormat format, size_t offset) = 0;
